<template>
  <div>
    <nav class="navbar navbar-toggleable-md navbar-light">
      <button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse" data-targe="#navbarHeader" aria-controls="navbarHeader" aria-expanded="false" aria-label="Toggle navigation">
      ...
      <div class="collapse navbar-collapse" id="navbarHeader">
        ...
        <form class="form-inline my-2 my-lg-0">
          ...
          <button v-if="!isAuthenticated" class="btn btn-secondary" @click="onLogout">Go to start page</button>
        </form>
      </div>
    </nav>
  </div>
